...
struct TagDetection {
  ...
  */
  Eigen::Matrix4d getRelativeTransform(double tag_size, double fx, double fy,
                                       double px, double py, cv::Mat distParams) const;
  ...
  void getRelativeTranslationRotation(double tag_size, double fx, double fy, double px, double py, cv::Mat distParams,
